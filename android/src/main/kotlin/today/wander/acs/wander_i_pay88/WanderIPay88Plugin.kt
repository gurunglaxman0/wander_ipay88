    ...
    when (call.method) {
      "checkout" -> {
        ...
        activity?.let { a ->
          ...
          iPayIHPayment.refNo =call.argument<String>("refNo") ?: ""
          iPayIHPayment.paymentId =call.argument<String>("paymentId") ?: ""
          iPayIHPayment.merchantKey = call.argument<String>("merchantKey") ?: ""
          iPayIHPayment.merchantCode = call.argument<String>("merchantCode") ?: ""
          iPayIHPayment.backendPostURL = call.argument<String>("backendPostURL") ?: ""
          iPayIHPayment.amount = call.argument<String>("amount") ?: "1.00"
          iPayIHPayment.currency = call.argument<String>("currency") ?: "MYR"
          iPayIHPayment.prodDesc = call.argument<String>("prodDesc") ?: ""

          iPayIHPayment.userName =  call.argument<String>("userName") ?: ""
          iPayIHPayment.userEmail = call.argument<String>("userEmail") ?: ""
          iPayIHPayment.remark = call.argument<String>("remark")
          iPayIHPayment.actionType = call.argument<String>("actionType")
          iPayIHPayment.country = call.argument<String>("country") ?: "MY"
//          iPayIHPayment.userContact = ""
          iPayIHPayment. lang = call.argument<String>("lang")

          val ipayIntent = IPayIH.getInstance().checkout(iPayIHPayment, a,channelDelegate, IPayIH.PAY_METHOD_CREDIT_CARD )
          a.startActivityForResult(ipayIntent, 1)
